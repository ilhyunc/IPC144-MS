...
int inputIntRange(int lowerRange, int upperRange);//This function enter and return a single character value within the list of valid characters. If entered character is not in the list of valid characters, display an error message and prompt again
